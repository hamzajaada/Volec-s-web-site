    ...
    @section('content')
        <section class="services-p">
            ...
            <section class="AF">
               ...
               <div class="card-act">
                <div class="picture"><img src="{{  asset('image/Cliente/'.$client->image)  }}" alt="" srcset=""></div>

                <div class="btn-mp">
                    <form style="box-shadow: none" method="POST" action="{{ route('clients.supprimer',$client->id) }}">
                        @csrf
                        @method('DELETE') 
