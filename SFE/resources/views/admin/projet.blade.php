    ...
    @section('content')
        <section class="services-p">
            ...
            <section class="AF">
               ...
               <div class="card-act">
                <div class="picture"><img src="{{  asset('image/Projet/'.$projet->image)  }}" alt="" srcset=""></div>
                <div class="caption">  
                ...
                <div class="btn-mp">
                    ...
                    <a href="{{route('view-projet2',$projet->id)}}" class="ope"><i style="color: rgba(38, 38, 211, 0.756)" class="fa-solid fa-pen-to-square"></i></a>
