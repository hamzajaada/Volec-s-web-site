...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/ajoute-categorie.css') }}">
...
<div id="app">
    ...
    <section class="services-p">
        ...
        <section class="AF"  >
            <h1 class="titre-Ajouteoffre">Ajouter une <span >catégorie de services </span></h1>
            <div class="info-compte">
                <form class="row g-3" method="post" action="{{ route('categorie.ajouter') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group2" >
                        <label for="exampleFormControlTextarea1">Nom de catégorie:</label>
                        <input name="nom_categorie" class="form-control" type="text"  aria-label="default input example">
                    ...
                    <div class="col-12">
                        <label for="inputImage" class="form-label">Image de catégorie de services </label>
