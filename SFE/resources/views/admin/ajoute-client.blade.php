...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/ajoute-client.css') }}">
...
<body>
    ...
    <section class="services-p">
        ...
        <section class="AF"  >
            <h1 class="titre-Ajouteoffre">Ajouter un <span >client</span></h1>
            <div class="info-compte">
                <form class="row g-3" method="post" action="{{ route('Client.ajouter') }}" enctype="multipart/form-data">
                    @csrf
