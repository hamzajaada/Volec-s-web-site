...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/ajoute-secteur.css') }}">
...
<body>
    ...
    <section class="services-p">
        ...
        <section class="AF"  >
            <h1 class="titre-Ajouteoffre">Ajouter un <span >Secteur d'activite </span></h1>
            <div class="info-compte">
                <form class="row g-3" method="post" action="{{ route('secteur.ajouter') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group2" >
                        <label for="exampleFormControlTextarea1">Secteur D'activite:</label>
                        <textarea class="form-control" name="categorie" id="exampleFormControlTextarea1" rows="3"></textarea>
                    </div>
                    <div class="col-12">
                        <label for="inputImage" class="form-label">Image de secteur d'activite </label>
